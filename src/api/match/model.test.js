...
beforeEach(async () => {
  match = await Match.create({ _tournamentId: new Types.ObjectId(), _player1Id: new Types.ObjectId(), _player2Id: new Types.ObjectId(), _winnerId: new Types.ObjectId(), _loserId: new Types.ObjectId(), score: 'test', round: 1, challongeMatchObj: 'test' })
})
