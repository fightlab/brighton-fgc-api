...
router.post('/',
  ...
  body({ name, _gameId, isCurrent, meta, points }),
  create)
...
/**
 * @api {get} /series/:id/standings Retrieve standings for a series
 * @apiName RetrieveSeriesStandings
 * @apiGroup Series
 * @apiSuccess {Object[]} series Series's list of standings.
 * @apiError {Object} 400 Some parameters may contain invalid values.
...
/**
 * @api {get} /series/:id/tournaments Retrieve tournaments for a series
 * @apiName RetrieveSeriesTournaments
 * @apiGroup Series
 * @apiSuccess {Object[]} series Series's list of tournaments.
 * @apiError {Object} 400 Some parameters may contain invalid values.
 * @apiError 422 Invalid parameter.
 */
